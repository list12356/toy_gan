...
python3 brs_gan.py --dir="mnist_binary_alpha_01_loss1_sigma" --alpha=0.1 --l=1 --mode="binary" --sigma=1&
python3 brs_gan.py --dir="mnist_binary_alpha_001_loss1_sigma" --alpha=0.01 --l=1 --mode="binary" --sigma=1&
python3 brs_gan.py --dir="mnist_binary_alpha_0001_loss1_sigma" --alpha=0.001 --l=1 --mode="binary" --sigma=1&
...
python3 brs_gan.py --dir="mnist_binary_alpha_01_loss1_nosigma" --alpha=0.1 --l=1 --mode="binary" --sigma=0&
python3 brs_gan.py --dir="mnist_binary_alpha_001_loss1_nosigma" --alpha=0.01 --l=1 --mode="binary" --sigma=0&
python3 brs_gan.py --dir="mnist_binary_alpha_0001_loss1_nosigma" --alpha=0.001 --l=1 --mode="binary" --sigma=0&
